...
const PRODUCTS: Product[] = [
  ...
  { id: '14', name: 'Hormonal Implants & Devices', brand: 'Vida', Category: 'Devices', img: require('../assets/images/medicine.png'), img1: require('../assets/images/medicine.png'), pts: 29, rating: 4.5, price: 500, description: 'Hormonal Implants & Devices are medical devices for hormonal contraception.', ingredients: ['Hormones', 'Medical Materials'] },
  { id: '15', name: 'Non-Hormonal Devices', brand: 'Vida', Category: 'Devices', img: require('../assets/images/Devices.png'), img1: require('../assets/images/Devices.png'), pts: 29, rating: 4.5, price: 600, description: 'Non-Hormonal Devices are medical devices for contraception without hormones.', ingredients: ['Medical Materials'] },
  { id: '16', name: 'Femjack', brand: 'Vida', Category: 'Medicines', img: require('../assets/images/Femjack.png'), img1: require('../assets/images/okDotted.png'), img2: require('../assets/images/okDotted.png'), pts: 25, rating: 5, price: 220, description: 'Femjack is a contraceptive pill for women.', ingredients: ['Progestin', 'Estrogen'] },
  { id: '17', name: 'Misotin', brand: 'Vida', Category: 'Medicines', img: require('../assets/images/Misotin.png'), img1: require('../assets/images/okDelay.png'), img2: require('../assets/images/okDelay.png'), pts: 29, rating: 5, price: 990, description: 'Misotin is a contraceptive pill for women.', ingredients: ['Progestin', 'Estrogen'] },
  { id: '18', name: 'S.T Mom', brand: 'Vida', Category: 'Medicines', pts: 29, img: require('../assets/images/Mom.png'), img1: require('../assets/images/strawberryGel.png'), rating: 4.5, price: 350, description: 'S.T Mom is a contraceptive pill for women.', ingredients: ['Progestin', 'Estrogen'] },
  { id: '19', name: 'Ismila-28F', brand: 'Vida', Category: 'Medicines', pts: 25, img: require('../assets/images/Ismila.png'), img1: require('../assets/images/fantasyGel.png'), rating: 4.5, price: 420, description: 'Ismila-28F is a contraceptive pill for women.', ingredients: ['Progestin', 'Estrogen'] },
  { id: '20', name: 'E-Pills', brand: 'Vida', Category: 'Medicines', img: require('../assets/images/Pill.png'), img1: require('../assets/images/medicine.png'), pts: 29, rating: 4.5, price: 500, description: 'E-Pills are contraceptive pills for women.', ingredients: ['Progestin', 'Estrogen'] },
  { id: '21', name: 'Zevion', brand: 'Vida', Category: 'Medicines', img: require('../assets/images/Zevion.png'), img1: require('../assets/images/Devices.png'), pts: 29, rating: 4.5, price: 600, description: 'Zevion is a contraceptive pill for women.', ingredients: ['Progestin', 'Estrogen'] },
];
export { PRODUCTS };
export type { Product };
